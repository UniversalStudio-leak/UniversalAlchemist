...
import ru.universalstudio.universalalchemist.gui.opener.*;
...
public class InventoryManager {
    ...
    public static InventoryManager manager() {
        return manager != null ? manager : (manager = new InventoryManager(JavaPlugin.getProvidingPlugin(InventoryManager.class)));
    }
